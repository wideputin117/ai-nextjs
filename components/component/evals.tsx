 ...
 * @see https://v0.dev/t/NvQJNHX1BDl
 */
          ...
          <div className="flex-1">
            <form>
              <div className="relative">
                ...
                <Input
                  className="pl-8 md:w-2/3 lg:w-1/3 bg-white shadow-none appearance-none"
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">MNIST Handwritten Digits</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>Spam Detection</TableCell>
                  <TableCell className="hidden md:table-cell">Emails</TableCell>
                  <TableCell className="hidden md:table-cell">January 5, 2022</TableCell>
                  <TableCell className="hidden sm:table-cell">Completed</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-medium">#3204</TableCell>
                  <TableCell>Sentiment Analysis</TableCell>
                  <TableCell className="hidden md:table-cell">Customer Reviews</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">Images</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>Language Translation</TableCell>
                  <TableCell className="hidden md:table-cell">Texts</TableCell>
...
function CheckSquareIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
